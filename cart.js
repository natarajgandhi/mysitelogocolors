...
function CartDAO(database) {
    ...
    this.getCart = function(userId, callback) {
        ...
        */
        ...
        this.db.collection("cart").find({ "userId": userId }, { "items": 1, "_id": 0 }).toArray(function (err, results) {
            //console.log(results);
            //userCart.items.push(results);
            //console.log(userCart);
            userCart.items = results[0].items;
            callback(userCart);
        });

        //var findCartObjects = function (db, callback) {
        //    console.log("inside findCart Objects method");
        //    var cursor = db.collection('cart').find({ "userId": userId }, { "items": 1, "_id": 0 });
        ...
        //var cursor = this.db.collection('cart').find({ "userId": userId }, { "items": 1, "_id": 0 });
        //cursor.each(function (err, doc) {
        //    if (doc != null) {
        //        //console.log(doc);
        //        cartItems.push(doc);
        ...
        //findCartObjects(this.db, function (doc) {
       ...
       // console.log('getCartmethod: user id is: ' + userId);
